...
<br>
                       <form id="form" name="form1" method="post" action="PrintReceivable.php">
                            
                            <div class="row">                                 
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <center><button type="submit" class="btn btn-primary" name="button" id="button">Print Active Receivables List</button>
                                    </div>
                                </div>
                            </div>
                       </form>             
