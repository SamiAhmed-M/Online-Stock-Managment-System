        ...
        <div class="container" >
            ...
            <div class="row main-low-margin" >
              ...
              <div class="col-md-2 col-sm-2" data-scrollreveal="enter left and move 100px, wait 0.8s">
                ...
                <div class="col-md-8  " data-scrollreveal="enter right and move 100px, wait 0.4s">
                        <h3>Edit Quantity Limit Detail</h3>
                        <hr />
			<div style="overflow:scroll; width:100%;height:290px" >
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <td>
<?php
//QFlagId sent from ManageQuantity.php
$Id=$_GET['QFlagId'];
// Establish Database selection and connection
include_once("eurekastock.php");
// Specify the query to execute
$sql = "select * from quantityflag where QFlagId='".$Id."'";
// Execute query
...
{
$ItemId=$row['ItemId'];
$QMin=$row['MinimumQuantity'];
$QMax=$row['MaximumQuantity'];
}
// Retrieve Goods Description from item table
...
?>
                    <form form name="form1" method="post" action="UpdateQuantity.php">
                     <table width="100%" border="0">
                      <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>System Quantity Flag Id:</div></label></td>
			<td>
		  	<input type="text" name="txtQuantityId" id="txtQuantityId" size="35" readonly="true" value="<?php echo $Id;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
                  	...
                  	<td>
                  	<label><div align="center">
                  	<strong>Minimum Quantity:</div></label></td>
			<td>
		  	<input type="text" name="txtMinQuantity" id="txtMinQuantity" size="35" value="<?php echo $QMin;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
	              ...
	              <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>Maximum Quantity:</div></label></td>
			<td>
		  	<input type="text" name="txtMaxQuantity" id="txtMaxQuantity" size="35" value="<?php echo $QMax;?>" />
                  	</td>
              	      </tr>
              	      <tr>
			<td>
