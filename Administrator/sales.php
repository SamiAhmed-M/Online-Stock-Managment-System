...
<body>   
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
		    ...
		    <li><strong><a href="sales.php">SALES REGISTRATION</a></strong></li>
    ...
    <div id="about-section">
        <div class="container" >
			...
			<form id="form1" name="form1" method="post" action="RegisterSales.php">
				...
				<div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" required="required"  placeholder="Quantity(Kg) for sale" name="txtQuantity" id="txtQuantity" size="75">
				    </div>
                                </div>
			 ...
			 <br> 
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="button" id="button">Register Sales Transaction</button>
                                    </div>
                                </div>
                            </div>
                       </form>
                       ...
                       <form id="form2" name="form1" method="post" action="ManageSales.php">
                                                        
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="button" id="button">Manage Registered Sales Information</button>
                                    </div>
                                </div>
                            </div>
                       </form>
