...
<td><div align="left"><?php echo $TransactionName;?></strong></div></td>
<td><div align="left"><a href="EditTransaction.php?TransactionId=<?php echo $Id;?>">Edit&nbsp;&nbsp;</a></div></td>
<td><div align="left"><a href="JavaScript:if(confirm('Transaction record and related Sales and Payment records will be deleted. Proceed?')==true){window.location='DeleteTransaction.php?TransactionId=<?php echo $Id;?>';}">Delete</a></div></td>
</tr>
<?php
}
...
<br>
                       <form id="form" name="form1" method="post" action="PrintTransaction.php">
                            
                            <div class="row">                                 
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <center><button type="submit" class="btn btn-primary" name="button" id="button">Print All Transaction List</button>
                                    </div>
                                </div>
                            </div>
                       </form>             
