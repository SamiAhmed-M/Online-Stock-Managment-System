...
<body>   
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
		    ...
		    <li><strong><a href="ItemDamage.php">DAMAGED ITEM REGISTRATION</a></strong></li>
        ...
        <div class="container" >
            <div class="row main-top-margin text-center" data-scrollreveal="enter top and move 100px, wait 0.3s">
                <div class="col-md-8 col-md-offset-2 ">
                   <h1>Damaged Item Registration</h1>
                </div>
            </div>
             <!-- ./ Main Heading-->
             <hr />
			...
			<form id="form1" name="form1" method="post" action="RegisterItemDamage.php">
				...
				<div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" required="required"  placeholder="Damaged Item Quantity(Kg)" name="txtQuantity" id="txtQuantity" size="75">
				    </div>
                                </div>
			 ...
			 <br> 
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="button" id="button">Register Damaged Quantity</button>
                                    </div>
                                </div>
                            </div>
                       </form>
