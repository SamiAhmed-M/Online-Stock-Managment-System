...
<td><div align="left"><a href="EditSupplier.php?SupplierId=<?php echo $Id;?>">Edit&nbsp;&nbsp;</a></div></td>
<td><div align="left"><a href="JavaScript:if(confirm('Supplier record and related purchase record will be deleted. And this might result in stock imbalance! Proceed?')==true){window.location='DeleteSupplier.php?SupplierId=<?php echo $Id;?>';}">Delete</a></div></td>
</tr>
<?php
}
