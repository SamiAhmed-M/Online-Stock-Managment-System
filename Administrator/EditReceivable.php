...
// Retrieve transaction Name from transaction table based on TransactionId
...
?>
                    <form form name="form1" method="post" action="UpdateReceivable.php">
                     <table width="100%" border="0">
                      <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>System Payment Id:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtPaymentId" id="txtPaymentId" size="40" readonly="true" value="<?php echo $PaymentId;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
			...
			<td>
		  	<input type="text" name="txtTransactionName" id="txtTransactionName" size="40" readonly="true" value="<?php echo $TransactionName;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
                  	...
                  	<td>
                  	<label><div align="center">
                  	<strong>Payment Date:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtPaymentDate" id="txtPaymentDate" size="40" onclick="ds_sh(this);" value="<?php echo $PaymentDate;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
	              ...
	              <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>Paid Amount:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtPaidAmount" id="txtPaidAmount" size="40" value="<?php echo $PaidAmount;?>" />
                  	</td>
              	      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
		      ...
		      <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>Debit Note No.:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtDebitNoteNo" id="txtDebitNoteNo" size="40" value="<?php echo $DebitNoteNo;?>" />
                  	</td>
              	      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
                  	...
                  	<td>
                  	<label><div align="center">
                  	<strong>Remark:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtRemark" id="txtRemark" size="40" value="<?php echo $Remark;?>" />
                  	</td>
              	      </tr>
		      <tr>
			<td>
