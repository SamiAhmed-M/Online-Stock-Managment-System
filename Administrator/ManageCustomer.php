...
<th bgcolor="#1CB5F1" ><div align="left" ><strong>Contact Person Name</strong></div></th>
<th bgcolor="#1CB5F1" ><div align="left" ><strong>Contact Person Tel</strong></div></th>
...
$sql = "select * from customer ORDER BY customer.CustomerId";
// Execute query
...
$ContactName=$row['ContactPersonName'];
$ContactTel=$row['ContactPersonTel'];
?>
<tr>

<td><div align="left"><?php echo $CustomerName;?></div></td>
<td><div align="left"><?php echo $ContactName;?></div></td>
<td><div align="left"><?php echo $ContactTel;?></div></td>
<td><div align="left"><a href="EditCustomer.php?CustomerId=<?php echo $Id;?>">Edit&nbsp;&nbsp;</a></div></td>
<td><div align="left"><a href="JavaScript:if(confirm('Customer record and related transaction, sales and payment records will be deleted. Proceed?')==true){window.location='DeleteCustomer.php?CustomerId=<?php echo $Id;?>';}">Delete</a></div></td>
</tr>
<?php
}
