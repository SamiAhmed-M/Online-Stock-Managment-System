...
<body>   
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
		    ...
		    <li><strong><a href="purchase.php">PURCHASE REGISTRATION</a></strong></li>
    ...
    <div id="about-section">
        <div class="container" >
			...
			<form id="form1" name="form1" method="post" action="RegisterPurchase.php">
				...
				<div class="col-md-4 ">
					...
					echo "<select style=\"width:175px\" name=\"cmbItem\" id=\"cmbItem\">";
				...
				<div class="col-md-4 ">
					...
					//Execute query
					$result = mysqli_query($con,$sql);
					echo "<select style=\"width:175px\" name=\"cmbSupplier\" id=\"cmbSupplier\">";
					// Loop through each records 
					while($row = mysqli_fetch_array($result))
					{
				...
				<div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" required="required"  placeholder="Purchase Date" name="txtPurchaseDate" id="txtPurchaseDate" onclick="ds_sh(this);" size="35">
				    </div>
                                </div>
				<div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control" required="required" placeholder="Quantity in KG" name="txtQuantity" id="txtQuantity" size="35">
				    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="button" id="button">Register Purchase Transaction</button>
                                    </div>
                                </div>
                            </div>
                       </form>
                       ...
                       <form id="form2" name="form1" method="post" action="ManagePurchase.php">
                                                        
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary" name="button" id="button">Manage Registered Purchase Information</button>
                                    </div>
                                </div>
                            </div>
                       </form>
