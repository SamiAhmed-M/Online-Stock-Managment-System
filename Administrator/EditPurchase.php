...
<body>   
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
		    ...
		    <li><strong><a href="ManagePurchase.php">PURCHASE TRANSACTION DETAIL MANAGEMENT</a></strong></li>
        ...
        <div class="container" >
            <div class="row main-top-margin text-center" data-scrollreveal="enter top and move 100px, wait 0.3s">
                <div class="col-md-8 col-md-offset-2 ">
                   <h1>Purchase Detail Management</h1>
                </div>
            </div>
             <!-- ./ Main Heading-->
             <hr />
			...
			<div style="overflow:scroll; width:100%;height:290px" >
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <td>
<?php
//PurchaseId sent from ManageManage.php
$Id=$_GET['PurchaseId'];
...
?>
                    <form form name="form1" method="post" action="UpdatePurchase.php">
                     <table width="100%" border="0">
                      <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>System Purchase Id:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtPurchaseId" id="txtPurchaseId" size="35" readonly="true" value="<?php echo $PurchaseId;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
                  	...
                  	<td>
                  	<label><div align="center">
                  	<strong>Item Description:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtItemDescription" id="txtItemDescription" size="35" readonly="true" value="<?php echo $ItemDescription;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
		      ...
		      <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>Supplier Name:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtSupplierName" id="txtSupplierName" size="35" readonly="true" value="<?php echo $SupplierName;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
		      ...
		      <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>Purchase Date:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtPurchaseDate" id="txtPurchaseDate" size="35" onclick="ds_sh(this);" value="<?php echo $PurchaseDate;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
			...
			<strong>  </div></label></td>
		      ...
		      <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>Quantity:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtQuantity" id="txtQuantity" size="35" value="<?php echo $Quantity;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
