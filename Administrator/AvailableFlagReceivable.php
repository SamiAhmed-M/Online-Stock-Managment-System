...
<body>   
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
		    ...
		    <li><strong><a href="AvailableFlagReceivable.php">RECEIVABLES PAST DUE DATE</a></strong></li>
        ...
        <div class="container" >
            <div class="row main-top-margin text-center" data-scrollreveal="enter top and move 100px, wait 0.3s">
                <div class="col-md-8 col-md-offset-2 ">
                   <h1>Receivables List Past Due Dates</h1>
                </div>
            </div>
             <!-- ./ Main Heading-->
             <hr />
            <div class="row main-low-margin" >
                ...
                <div class="col-md-6  " data-scrollreveal="enter right and move 100px, wait 0.4s">
                        <h3>List of Unsettled Amounts Past Due Dates</h3>
                        <hr />
...
<br>
                       <form id="form" name="form1" method="post" action="PrintReceivableFlag.php">
                            
                            <div class="row">                                 
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        <center><button type="submit" class="btn btn-primary" name="button" id="button">Print Receivables List Past Due Dates</button>
                                    </div>
                                </div>
                            </div>
                       </form>        
