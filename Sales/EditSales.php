...
<body>   
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
		    ...
		    <li><strong><a href="ManageSales.php">SALES TRANSACTION DETAIL MANAGEMENT</a></strong></li>
...
?>
                    <form form name="form1" method="post" action="UpdateSales.php">
                     <table width="100%" border="0">
                      <tr>
                  	<td>
                  	<label><div align="center">
                  	<strong>System Sales Id:</div></label>
                  	</td>
			<td>
		  	<input type="text" name="txtSalesId" id="txtSalesId" size="35" readonly="true" value="<?php echo $Id;?>" />
                  	</td>
                      </tr>
		      <tr>
			<td>
